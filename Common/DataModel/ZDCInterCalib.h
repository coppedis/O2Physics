...
namespace znoutput
{
DECLARE_SOA_COLUMN(ZNAtdc, timeZNA, float);     //! ZNA tdc value
DECLARE_SOA_COLUMN(ZNCtdc, timeZNC, float);     //! ZNC tdc value
DECLARE_SOA_COLUMN(ZNApmc, znacommonPM, float); //! PMC ZNA
...
DECLARE_SOA_COLUMN(ZNCpmc, znccommonPM, float); //! PMC ZNC
